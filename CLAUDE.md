...
| 别名 | 命令 | 服务器 | 用途 |
|------|------|--------|------|
| `sshtx` | `ssh -p 2222 root@43.133.224.11` | 腾讯云 (43.133.224.11) | 主服务器，部署官网等服务 |
| `ali.hamr.top` | `ssh -p 2222 root@39.103.188.33` | 阿里云 (39.103.188.33) | 监控等服务 |

**注意**：连接腾讯云服务器直接用 `sshtx` 命令。
